...
echo_and_run cd "/home/alex/Blind_sight/src/pico_zense_camera"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/alex/Blind_sight/src/pico_zense_camera/setup.py" \
     \
    build --build-base "/home/alex/Blind_sight/build/pico_zense_camera" \
    install \
    --root="${DESTDIR-/}" \
