...
//#line 291 "/opt/ros/melodic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      Default.abstract_parameters.push_back(compute_volume_nodeConfig::AbstractParamDescriptionConstPtr(new compute_volume_nodeConfig::ParamDescription<double>("perpendicular_threshold", "double", 1, "Nr_points_input_pointcloud", "", &compute_volume_nodeConfig::perpendicular_threshold)));
//#line 291 "/opt/ros/melodic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __param_descriptions__.push_back(compute_volume_nodeConfig::AbstractParamDescriptionConstPtr(new compute_volume_nodeConfig::ParamDescription<double>("perpendicular_threshold", "double", 1, "Nr_points_input_pointcloud", "", &compute_volume_nodeConfig::perpendicular_threshold)));
//#line 291 "/opt/ros/melodic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
...
//#line 291 "/opt/ros/melodic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      Default.abstract_parameters.push_back(compute_volume_nodeConfig::AbstractParamDescriptionConstPtr(new compute_volume_nodeConfig::ParamDescription<double>("parallel_threshold", "double", 1, "Nr_points_input_pointcloud", "", &compute_volume_nodeConfig::parallel_threshold)));
//#line 291 "/opt/ros/melodic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __param_descriptions__.push_back(compute_volume_nodeConfig::AbstractParamDescriptionConstPtr(new compute_volume_nodeConfig::ParamDescription<double>("parallel_threshold", "double", 1, "Nr_points_input_pointcloud", "", &compute_volume_nodeConfig::parallel_threshold)));
